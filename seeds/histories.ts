...
const histories: WorkHistory[] = [
  ...
  { id: 4, start_on: oneIndexedDate(2025, 2, 1), end_on: undefined, content: "芸能グループ向け告知サイト開発", work_type: "it_engineer", point: false },
  { id: 5, start_on: oneIndexedDate(2024, 7, 1), content: "MORE MORE TYPE! 発足", work_type: "idol", point: true },
  { id: 6, start_on: oneIndexedDate(2024, 12, 1), content: "MORE MORE TYPE! 初のオリジナル曲「インターフェース」発表", work_type: "idol", point: true },
  { id: 7, start_on: oneIndexedDate(2025, 5, 1), content: "MORE MORE TYPE! がREACT TRACT様と初のコラボ配信を実施", work_type: "idol", point: true },
  { id: 8, start_on: oneIndexedDate(2025, 7, 1), content: "MORE MORE TYPE! ファーストアルバム「extends」発売予定", work_type: "idol", point: true },
];

export default JSON.stringify(histories);
